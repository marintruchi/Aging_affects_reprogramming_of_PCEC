...
## ---------------------------- YoungD14 ---------------------------- ##
#LOAD HTO COUNTS
matrix_dir = "/data/truchi_data/DATA/GEO_data_submission_Truchi_et_al/YD14/"
...
## ---------------------------- YoungD28 ---------------------------- ##
#LOAD HTO COUNTS
matrix_dir = "/data/truchi_data/DATA/GEO_data_submission_Truchi_et_al/YD28/"
...
## ---------------------------- YoungD60 ---------------------------- ##
#LOAD HTO COUNTS
matrix_dir = "/data/truchi_data/DATA/GEO_data_submission_Truchi_et_al/YD60/"
...
## ---------------------------- OldD14 ---------------------------- ##
#LOAD HTO COUNTS
matrix_dir = "/data/truchi_data/DATA/GEO_data_submission_Truchi_et_al/OD14/"
...
## ---------------------------- OldD28 ---------------------------- ##
#LOAD HTO COUNTS
matrix_dir = "/data/truchi_data/DATA/GEO_data_submission_Truchi_et_al/OD28/"
...
## ---------------------------- OldD60 ---------------------------- ##
#LOAD HTO COUNTS
matrix_dir = "/data/truchi_data/DATA/GEO_data_submission_Truchi_et_al/OD60/"
...
saveRDS(aggr,"/data/truchi_data/Rdata_objects/before_integration.rds")
